...
(() ->
	...
	simple.equal 69, process.env.value, '1'
	)()
...
(() ->
	...
	simple.equal 83, process.env.value, '2'
	)()
...
(() ->
	...
	simple.equal 94, process.env.value, '2'
	)()
...
(() ->
	...
	simple.equal 105, process.env.value, '3'
	)()
...
(() ->
	...
	simple.equal 113, process.env.value, '3'
	)()
