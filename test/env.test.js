...
(function() {
  var oInput, tree;
  oInput = new EnvInput(`development = yes
if development
	color = red
	if usemoods
		mood = somber
...
// --- test using .env file
(function() {
  var contents, expect, filepath, oInput, tree;
	...
	body:
		...
		-
			node:
				...
				value: happy
			lineNum: 6`);
  return simple.equal(100, tree, expect);
})();
...
dir_data = $dir_root/data`);
  tree = oInput.getTree();
  procEnv(tree);
  return simple.equal(159, getenv('dir_data'), "/usr/project/data");
})();
...
(function() {
  ...
  return simple.equal(150, getenv('mood'), 'somber');
})();
...
sb.dev = yes`, 'sb.');
  ...
  return simple.equal(191, getenv('sb.dev'), 'yes');
})();
